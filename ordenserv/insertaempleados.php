...
<div class="main-container">
      ...
      <main class="main-content">
        ...
        <form id="form1" name="form1" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
            ...
            Clave:<input name="clave" type="password" id="clave" />
        ...
        if(isset($_POST['submit'])){
            ...
            $consulta="insert into empleados(nombre,ci,direccion,telefono,email,contrasenia) values('$nombre',' $ci','$direccion','$telefono','$email',' $clave')";
