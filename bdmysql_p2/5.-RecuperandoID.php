...
try {
    ...
    // Recuperamos el ID que se registro
    $id = $conexion->lastInsertId(); // lastInsertId(): este metodo recupera el ID del último registro insertado en la base de datos utilizando la conexión establecida.
    echo "<br>Datos insertados... <br>Id insertado: " . $id;
